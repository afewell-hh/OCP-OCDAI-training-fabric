# OPG-512 — Dual-Plane Backend (CX8 2x400G, BF3 2x200G, Converged Storage)

This building block provides a 512-xPU training cluster with two independent backend fabrics (Plane A and Plane B). Each GPU connects via a ConnectX-8 dual-port 400G NIC: port 0 to Plane A and port 1 to Plane B. Frontend uses BF3 2x200G with L3 multihoming. The dual-plane design allows plane-level maintenance and isolation while doubling the aggregate backend bandwidth compared to a single-plane Clos at this scale.

## Intended use

- Choose this OPG when plane-level isolation for maintenance and failure containment is required at the 512-xPU tier.
- Use when aggregate backend bandwidth headroom must exceed what a single-plane Clos provides for busy clusters with large collectives.
...
| Role | Count | Notes |
|------|-------|-------|
| Compute servers (8 xPU each) | 64 | 512 xPUs total; each server has 8x CX8 dual-port NICs |
...
- [`xoc-512/1x-OPG-512/dual-plane--cx8-2x400g--bf3-2x200g--2p--storage-conv-2x200g`](../../../xoc/xoc-512/1x-OPG-512/dual-plane--cx8-2x400g--bf3-2x200g--2p--storage-conv-2x200g/)
- [`xoc-1024/2x-OPG-512/dual-plane--cx8-2x400g--bf3-2x200g--2p--storage-conv-2x200g`](../../../xoc/xoc-1024/2x-OPG-512/dual-plane--cx8-2x400g--bf3-2x200g--2p--storage-conv-2x200g/)
